...
function nFibonacci(n) {
 ...
 let n2=1; // 1- 1 -2 -3 -5 - 8 -13

n2=n1+n2; // 1 -2  - 3 -5 -8 -13 -21
n1=n2-n1; // 1- 1 -  2 -3 -5 -8 -14
return n2+nFibonacci(n-1); // 1 -2 
...
var queue = new Queue();
Queue.prototype.enqueue=function(elemt) {
  this.array.push(elemt)
};
